  ...
  return (
    <>
      <div className={cls.info}>
        <a download href="/docs/Положение_об_обработке_ПД_Оганян.doc">
          Обработка персональных данных
        </a>

        <a download href="/docs/СОГЛАСИЕ_на_обработку_ПД_ИП_Оганян.doc">
          Согласие на обработку персональных данных
        </a>

        <a download href="/docs/пользовательское_соглашение_ИП_Оганян.docx">

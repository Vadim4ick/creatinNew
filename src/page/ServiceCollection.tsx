...
const ServiceCollection = ({
  ...
  serviceCollection: GetServiceCollectionByIdQuery["serviceCollection"]["data"]["attributes"];
}) => {
  return (
        ...
        <div className="page__base">
          ...
          >
            <div className="hero__left">
              <h1 className="hero__title">{serviceCollection.title}</h1>
          ...
          {serviceCollection.sliderCase.cases.data && (
            <RelevantProjects
              animation={true}

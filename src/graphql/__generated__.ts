...
export type Case = {
  ...
  readonly imageBigMobile: Maybe<UploadFileEntityResponse>;
...
export type CaseInput = {
  ...
  readonly imageBigMobile: InputMaybe<Scalars['ID']['input']>;

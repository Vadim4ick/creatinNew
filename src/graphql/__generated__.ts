...
export type Scalars = {
  ...
  ServiceCollectionContentDynamicZoneInput: { input: any; output: any; }
...
export type Banner = {
  ...
  readonly bgColorServiceBanner: Maybe<Scalars['String']['output']>;
  readonly button: Maybe<ComponentUiLink>;
  readonly colorImageEffectServiceBanner: Maybe<Scalars['String']['output']>;
  readonly createdAt: Maybe<Scalars['DateTime']['output']>;
  readonly description: Maybe<Scalars['String']['output']>;
  readonly imgDesktop: UploadFileEntityResponse;
  readonly imgMobile: UploadFileEntityResponse;
  readonly imgServiceBanner: Maybe<UploadFileEntityResponse>;
...
export type BannerFiltersInput = {
  ...
  readonly bgColorServiceBanner: InputMaybe<StringFilterInput>;
  readonly button: InputMaybe<ComponentUiLinkFiltersInput>;
  readonly colorImageEffectServiceBanner: InputMaybe<StringFilterInput>;
  readonly createdAt: InputMaybe<DateTimeFilterInput>;
...
export type BannerInput = {
  readonly bgColorServiceBanner: InputMaybe<Scalars['String']['input']>;
  readonly button: InputMaybe<ComponentUiLinkInput>;
  readonly colorImageEffectServiceBanner: InputMaybe<Scalars['String']['input']>;
  readonly description: InputMaybe<Scalars['String']['input']>;
  readonly imgDesktop: InputMaybe<Scalars['ID']['input']>;
  readonly imgMobile: InputMaybe<Scalars['ID']['input']>;
  readonly imgServiceBanner: InputMaybe<Scalars['ID']['input']>;
...
export type Case = {
  ...
  readonly imageMainMobile: Maybe<UploadFileEntityResponse>;
...
export type CaseContentDynamicZone = ComponentImageBlocksAboutProject | ComponentImageBlocksDoubleImage | ComponentImageBlocksGridImage | ComponentImageBlocksOneImage | ComponentImageBlocksTextBlock | ComponentImageBlocksVideo | Error;
...
export type CaseInput = {
  ...
  readonly imageMainMobile: InputMaybe<Scalars['ID']['input']>;
...
export type ComponentBlocksServiceColorImage = {
  readonly __typename?: 'ComponentBlocksServiceColorImage';
  readonly bgBtn: Maybe<Scalars['String']['output']>;
  readonly color: Maybe<Scalars['String']['output']>;
  readonly id: Scalars['ID']['output'];
};

export type ComponentBlocksServiceColorImageFiltersInput = {
  readonly and: InputMaybe<ReadonlyArray<InputMaybe<ComponentBlocksServiceColorImageFiltersInput>>>;
  readonly bgBtn: InputMaybe<StringFilterInput>;
  readonly color: InputMaybe<StringFilterInput>;
  readonly not: InputMaybe<ComponentBlocksServiceColorImageFiltersInput>;
  readonly or: InputMaybe<ReadonlyArray<InputMaybe<ComponentBlocksServiceColorImageFiltersInput>>>;
};

export type ComponentBlocksServiceColorImageInput = {
  readonly bgBtn: InputMaybe<Scalars['String']['input']>;
...
export type ComponentElementsTitle = {
  ...
  readonly activeTitle: Maybe<Scalars['Boolean']['output']>;
  readonly id: Scalars['ID']['output'];
  readonly title: Scalars['String']['output'];
};

export type ComponentElementsTitleFiltersInput = {
  readonly activeTitle: InputMaybe<BooleanFilterInput>;
...
export type ComponentElementsTitleInput = {
  readonly activeTitle: InputMaybe<Scalars['Boolean']['input']>;
  readonly id: InputMaybe<Scalars['ID']['input']>;
  readonly title: InputMaybe<Scalars['String']['input']>;
};
...
export type ComponentImageBlocksAboutProject = {
  readonly __typename?: 'ComponentImageBlocksAboutProject';
  readonly client: Scalars['String']['output'];
  readonly deadline: Maybe<Scalars['Int']['output']>;
  readonly id: Scalars['ID']['output'];
  readonly idBlock: Scalars['String']['output'];
  readonly industry: Maybe<Scalars['String']['output']>;
  readonly tasks: Scalars['String']['output'];
};
...
export type ComponentImageBlocksDoubleImage = {
  ...
  readonly mobileImageOne: Maybe<UploadFileEntityResponse>;
  readonly mobileImageTwo: Maybe<UploadFileEntityResponse>;
};
...
export type ComponentImageBlocksGridImage = {
  ...
  readonly idBlock: Scalars['String']['output'];
  readonly mobileImageOne: Maybe<UploadFileEntityResponse>;
  readonly mobileImageThree: Maybe<UploadFileEntityResponse>;
  readonly mobileImageTwo: Maybe<UploadFileEntityResponse>;
...
export type ComponentImageBlocksOneImage = {
  ...
  readonly mobileImage: Maybe<UploadFileEntityResponse>;
};
...
export type ComponentSectionsPartners = {
  ...
  readonly id: Scalars['ID']['output'];
  readonly our_partners: Maybe<OurPartnerRelationResponseCollection>;
  readonly title: Scalars['String']['output'];
};


export type ComponentSectionsPartnersOur_PartnersArgs = {
...
export type ComponentServicesContentSingleImageBlock = {
  readonly __typename?: 'ComponentServicesContentSingleImageBlock';
  readonly description: Maybe<Scalars['String']['output']>;
  readonly id: Scalars['ID']['output'];
  readonly idBlock: Scalars['String']['output'];
...
export type ComponentServicesContentSingleImageBlockImageArgs = {
  filters: InputMaybe<UploadFileFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<ReadonlyArray<InputMaybe<Scalars['String']['input']>>>;
};

export type ComponentServicesContentTextVariant = {
  readonly __typename?: 'ComponentServicesContentTextVariant';
  readonly description: Maybe<Scalars['String']['output']>;
  readonly id: Scalars['ID']['output'];
  readonly idBlock: Scalars['String']['output'];
  readonly title: Scalars['String']['output'];
...
export type GenericMorph = AskedQuestion | Banner | Case | CaseName | Complex | ComplexAccompany | ComponentBlocksIncludesHover | ComponentBlocksServiceColorImage | ComponentComponentsComplexComponent | ComponentComponentsOfferComponent | ComponentComponentsSliderCase | ComponentComponentsTextBlock | ComponentComponentsVacancies | ComponentElementsIncludesContent | ComponentElementsIntroCard | ComponentElementsOffer | ComponentElementsTitle | ComponentElementsVacancy | ComponentImageBlocksAboutProject | ComponentImageBlocksDoubleImage | ComponentImageBlocksDoubleTextBlocks | ComponentImageBlocksGridImage | ComponentImageBlocksOneImage | ComponentImageBlocksTextBlock | ComponentImageBlocksVideo | ComponentSectionsAboutSection | ComponentSectionsFormSend | ComponentSectionsPartners | ComponentSectionsSectionTitles | ComponentSectionsServices | ComponentServicesContentSingleImageBlock | ComponentServicesContentTextVariant | ComponentSharedMetaSocial | ComponentSharedSeo | ComponentUiLink | ComponentUiMobileLink | FormFeedback | HomeBaner | HomePage | I18NLocale | IncludesBlock | Offer | OffersPage | OurPartner | Portfolio | SearchLink | Service | ServiceCollection | ServiceName | Studio | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | Vacancy;

export type HomeBaner = {
...
export type HomeBanerEntity = {
  readonly __typename?: 'HomeBanerEntity';
  readonly attributes: Maybe<HomeBaner>;
  readonly id: Maybe<Scalars['ID']['output']>;
};

export type HomeBanerEntityResponse = {
  readonly __typename?: 'HomeBanerEntityResponse';
  readonly data: Maybe<HomeBanerEntity>;
};

export type HomeBanerEntityResponseCollection = {
  readonly __typename?: 'HomeBanerEntityResponseCollection';
  readonly data: ReadonlyArray<HomeBanerEntity>;
  readonly meta: ResponseCollectionMeta;
};

export type HomeBanerFiltersInput = {
...
export type HomeBanerRelationResponseCollection = {
  readonly __typename?: 'HomeBanerRelationResponseCollection';
  readonly data: ReadonlyArray<HomeBanerEntity>;
};

export type HomePage = {
  readonly __typename?: 'HomePage';
  readonly banera_dlya_glavnoj_straniczies: Maybe<HomeBanerRelationResponseCollection>;
  readonly cases: Maybe<CaseRelationResponseCollection>;
  readonly createdAt: Maybe<Scalars['DateTime']['output']>;
  readonly publishedAt: Maybe<Scalars['DateTime']['output']>;
  readonly seo: Maybe<ComponentSharedSeo>;
...
export type HomePageBanera_Dlya_Glavnoj_StranicziesArgs = {
  filters: InputMaybe<HomeBanerFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  publicationState?: InputMaybe<PublicationState>;
  sort?: InputMaybe<ReadonlyArray<InputMaybe<Scalars['String']['input']>>>;
};
...
export type HomePageInput = {
  readonly banera_dlya_glavnoj_straniczies: InputMaybe<ReadonlyArray<InputMaybe<Scalars['ID']['input']>>>;
  readonly cases: InputMaybe<ReadonlyArray<InputMaybe<Scalars['ID']['input']>>>;
  readonly publishedAt: InputMaybe<Scalars['DateTime']['input']>;
  readonly seo: InputMaybe<ComponentSharedSeoInput>;
};
...
export type Mutation = {
  ...
  readonly createHomeBaner: Maybe<HomeBanerEntityResponse>;
  readonly createIncludesBlock: Maybe<IncludesBlockEntityResponse>;
  readonly createOffer: Maybe<OfferEntityResponse>;
  readonly createOurPartner: Maybe<OurPartnerEntityResponse>;
  ...
  readonly deleteHomeBaner: Maybe<HomeBanerEntityResponse>;
  ...
  readonly deleteOurPartner: Maybe<OurPartnerEntityResponse>;
  ...
  readonly updateHomeBaner: Maybe<HomeBanerEntityResponse>;
  ...
  readonly updateOurPartner: Maybe<OurPartnerEntityResponse>;
...
export type MutationCreateHomeBanerArgs = {
  data: HomeBanerInput;
};
...
export type MutationDeleteHomeBanerArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUpdateHomeBanerArgs = {
  data: HomeBanerInput;
  id: Scalars['ID']['input'];
};
...
export type OurPartner = {
  readonly __typename?: 'OurPartner';
  readonly createdAt: Maybe<Scalars['DateTime']['output']>;
  readonly fillImage: UploadFileEntityResponse;
  readonly noFillImage: UploadFileEntityResponse;
  readonly publishedAt: Maybe<Scalars['DateTime']['output']>;
  readonly title: Scalars['String']['output'];
  readonly updatedAt: Maybe<Scalars['DateTime']['output']>;
};

export type OurPartnerEntity = {
  readonly __typename?: 'OurPartnerEntity';
  readonly attributes: Maybe<OurPartner>;
  readonly id: Maybe<Scalars['ID']['output']>;
};

export type OurPartnerEntityResponse = {
  readonly __typename?: 'OurPartnerEntityResponse';
  readonly data: Maybe<OurPartnerEntity>;
};

export type OurPartnerEntityResponseCollection = {
  readonly __typename?: 'OurPartnerEntityResponseCollection';
  readonly data: ReadonlyArray<OurPartnerEntity>;
  readonly meta: ResponseCollectionMeta;
};

export type OurPartnerFiltersInput = {
  readonly and: InputMaybe<ReadonlyArray<InputMaybe<OurPartnerFiltersInput>>>;
  readonly createdAt: InputMaybe<DateTimeFilterInput>;
  readonly id: InputMaybe<IdFilterInput>;
  readonly not: InputMaybe<OurPartnerFiltersInput>;
  readonly or: InputMaybe<ReadonlyArray<InputMaybe<OurPartnerFiltersInput>>>;
  readonly publishedAt: InputMaybe<DateTimeFilterInput>;
  readonly title: InputMaybe<StringFilterInput>;
  readonly updatedAt: InputMaybe<DateTimeFilterInput>;
};
...
export type OurPartnerInput = {
  readonly fillImage: InputMaybe<Scalars['ID']['input']>;
  readonly noFillImage: InputMaybe<Scalars['ID']['input']>;
  readonly publishedAt: InputMaybe<Scalars['DateTime']['input']>;
  readonly title: InputMaybe<Scalars['String']['input']>;
};

export type OurPartnerRelationResponseCollection = {
  readonly __typename?: 'OurPartnerRelationResponseCollection';
  readonly data: ReadonlyArray<OurPartnerEntity>;
};
...
export type PortfolioCasesArgs = {
  filters: InputMaybe<CaseFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  publicationState?: InputMaybe<PublicationState>;
  sort?: InputMaybe<ReadonlyArray<InputMaybe<Scalars['String']['input']>>>;
...
export type PortfolioEntity = {
  readonly __typename?: 'PortfolioEntity';
  readonly attributes: Maybe<Portfolio>;
  readonly id: Maybe<Scalars['ID']['output']>;
};

export type PortfolioEntityResponse = {
  readonly __typename?: 'PortfolioEntityResponse';
  readonly data: Maybe<PortfolioEntity>;
};
...
export type Query = {
  ...
  readonly homeBaner: Maybe<HomeBanerEntityResponse>;
  readonly homeBaners: Maybe<HomeBanerEntityResponseCollection>;
  ...
  readonly ourPartner: Maybe<OurPartnerEntityResponse>;
  readonly ourPartners: Maybe<OurPartnerEntityResponseCollection>;
...
export type QueryHomeBanerArgs = {
  id: InputMaybe<Scalars['ID']['input']>;
};


export type QueryHomeBanersArgs = {
  filters: InputMaybe<HomeBanerFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  publicationState?: InputMaybe<PublicationState>;
  sort?: InputMaybe<ReadonlyArray<InputMaybe<Scalars['String']['input']>>>;
...
export type Service = {
  ...
  readonly SliderCase: Maybe<ComponentComponentsSliderCase>;
  readonly content: Maybe<ReadonlyArray<Maybe<ServiceContentDynamicZone>>>;
...
export type ServiceCollection = {
  ...
  readonly Title: Maybe<ComponentSectionsSectionTitles>;
  readonly content: Maybe<ReadonlyArray<Maybe<ServiceCollectionContentDynamicZone>>>;
  readonly contentBanner: Maybe<BannerEntityResponse>;
  readonly createdAt: Maybe<Scalars['DateTime']['output']>;
  readonly deadlines: Maybe<Scalars['String']['output']>;
  readonly descCard: Maybe<Scalars['String']['output']>;
  readonly description: Scalars['String']['output'];
  readonly name: Scalars['String']['output'];
  readonly price: Scalars['Long']['output'];
  readonly publishedAt: Maybe<Scalars['DateTime']['output']>;
  readonly serviceColorImageComponent: Maybe<ComponentBlocksServiceColorImage>;
  readonly sliderCase: Maybe<ComponentComponentsSliderCase>;
  readonly textBlocks: Maybe<ReadonlyArray<Maybe<ComponentComponentsTextBlock>>>;
  readonly updatedAt: Maybe<Scalars['DateTime']['output']>;
  readonly video: Maybe<UploadFileEntityResponse>;
...
export type ServiceCollectionContentDynamicZone = ComponentServicesContentSingleImageBlock | ComponentServicesContentTextVariant | Error;
...
export type ServiceCollectionFiltersInput = {
  ...
  readonly createdAt: InputMaybe<DateTimeFilterInput>;
  readonly deadlines: InputMaybe<StringFilterInput>;
  readonly descCard: InputMaybe<StringFilterInput>;
  readonly description: InputMaybe<StringFilterInput>;
  readonly id: InputMaybe<IdFilterInput>;
  readonly name: InputMaybe<StringFilterInput>;
  ...
  readonly publishedAt: InputMaybe<DateTimeFilterInput>;
  readonly serviceColorImageComponent: InputMaybe<ComponentBlocksServiceColorImageFiltersInput>;
  readonly sliderCase: InputMaybe<ComponentComponentsSliderCaseFiltersInput>;
  readonly textBlocks: InputMaybe<ComponentComponentsTextBlockFiltersInput>;
  readonly updatedAt: InputMaybe<DateTimeFilterInput>;
};
...
export type ServiceCollectionInput = {
  readonly Title: InputMaybe<ComponentSectionsSectionTitlesInput>;
  readonly content: InputMaybe<ReadonlyArray<Scalars['ServiceCollectionContentDynamicZoneInput']['input']>>;
  readonly contentBanner: InputMaybe<Scalars['ID']['input']>;
  readonly deadlines: InputMaybe<Scalars['String']['input']>;
  readonly descCard: InputMaybe<Scalars['String']['input']>;
  readonly description: InputMaybe<Scalars['String']['input']>;
  readonly name: InputMaybe<Scalars['String']['input']>;
  readonly price: InputMaybe<Scalars['Long']['input']>;
  readonly publishedAt: InputMaybe<Scalars['DateTime']['input']>;
  readonly serviceColorImageComponent: InputMaybe<ComponentBlocksServiceColorImageInput>;
  readonly sliderCase: InputMaybe<ComponentComponentsSliderCaseInput>;
  readonly textBlocks: InputMaybe<ReadonlyArray<InputMaybe<ComponentComponentsTextBlockInput>>>;
...
export type ServiceContentDynamicZone = ComponentServicesContentSingleImageBlock | ComponentServicesContentTextVariant | Error;
...
export type ServiceInput = {
  ...
  readonly SliderCase: InputMaybe<ComponentComponentsSliderCaseInput>;
  readonly content: InputMaybe<ReadonlyArray<Scalars['ServiceContentDynamicZoneInput']['input']>>;
  readonly contentBanner: InputMaybe<Scalars['ID']['input']>;
  readonly description: InputMaybe<Scalars['String']['input']>;
  readonly publishedAt: InputMaybe<Scalars['DateTime']['input']>;
  readonly seo: InputMaybe<ComponentSharedSeoInput>;
...
export type GetServiceByIdQuery = { readonly __typename?: 'Query', readonly services: { readonly __typename?: 'ServiceEntityResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'ServiceEntity', readonly attributes: { readonly __typename?: 'Service', readonly title: string, readonly description: string, readonly SliderCase: { readonly __typename?: 'ComponentComponentsSliderCase', readonly id: string, readonly cases: { readonly __typename?: 'CaseRelationResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'CaseEntity', readonly id: string, readonly attributes: { readonly __typename?: 'Case', readonly title: string, readonly info: string, readonly imageMain: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly imageBig: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly imageMainMobile: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } }> } }, readonly Services: { readonly __typename?: 'ComponentSectionsServices', readonly id: string, readonly service_collections: { readonly __typename?: 'ServiceCollectionRelationResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'ServiceCollectionEntity', readonly id: string, readonly attributes: { readonly __typename?: 'ServiceCollection', readonly descCard: string, readonly name: string, readonly description: string, readonly price: any, readonly serviceColorImageComponent: { readonly __typename?: 'ComponentBlocksServiceColorImage', readonly color: string, readonly bgBtn: string }, readonly textBlocks: ReadonlyArray<{ readonly __typename?: 'ComponentComponentsTextBlock', readonly id: string, readonly titlle: string, readonly description: string }>, readonly sliderCase: { readonly __typename?: 'ComponentComponentsSliderCase', readonly id: string, readonly cases: { readonly __typename?: 'CaseRelationResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'CaseEntity', readonly id: string, readonly attributes: { readonly __typename?: 'Case', readonly title: string, readonly info: string, readonly imageMain: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly imageBig: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly imageMainMobile: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } }> } }, readonly video: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } }> } }, readonly content: ReadonlyArray<{ readonly __typename?: 'ComponentServicesContentSingleImageBlock', readonly idBlock: string, readonly id: string, readonly title: string, readonly description: string, readonly image: { readonly __typename?: 'UploadFileRelationResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } }> } } | { readonly __typename?: 'ComponentServicesContentTextVariant', readonly idBlock: string, readonly id: string, readonly title: string, readonly description: string } | { readonly __typename?: 'Error' }>, readonly textBlocks: ReadonlyArray<{ readonly __typename?: 'ComponentComponentsTextBlock', readonly id: string, readonly titlle: string, readonly description: string }>, readonly serviceName: { readonly __typename?: 'ServiceNameEntityResponse', readonly data: { readonly __typename?: 'ServiceNameEntity', readonly id: string, readonly attributes: { readonly __typename?: 'ServiceName', readonly name: string } } }, readonly video: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly contentBanner: { readonly __typename?: 'BannerEntityResponse', readonly data: { readonly __typename?: 'BannerEntity', readonly attributes: { readonly __typename?: 'Banner', readonly title: string, readonly description: string, readonly label: string, readonly bgColorServiceBanner: string, readonly colorImageEffectServiceBanner: string, readonly imgDesktop: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly imgMobile: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly button: { readonly __typename?: 'ComponentUiLink', readonly href: string, readonly name: string }, readonly imgServiceBanner: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly offerBannerMobile: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly offerBannerDesktop: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } } } } }> } };
...
export type GetCaseByIdQuery = { readonly __typename?: 'Query', readonly case: { readonly __typename?: 'CaseEntityResponse', readonly data: { readonly __typename?: 'CaseEntity', readonly attributes: { readonly __typename?: 'Case', readonly mobileName: string, readonly backround: any, readonly cases: { readonly __typename?: 'CaseRelationResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'CaseEntity', readonly id: string, readonly attributes: { readonly __typename?: 'Case', readonly title: string, readonly imageMain: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } }> }, readonly content: ReadonlyArray<{ readonly __typename?: 'ComponentImageBlocksAboutProject', readonly id: string, readonly idBlock: string, readonly client: string, readonly industry: string, readonly deadline: number, readonly tasks: string } | { readonly __typename?: 'ComponentImageBlocksDoubleImage', readonly id: string, readonly idBlock: string, readonly imageTwo: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly imageOne: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly mobileImageOne: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly mobileImageTwo: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } | { readonly __typename?: 'ComponentImageBlocksGridImage', readonly idBlock: string, readonly id: string, readonly selectStreech: any, readonly threeImage: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly twoImage: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly oneImage: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly mobileImageOne: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly mobileImageTwo: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly mobileImageThree: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } | { readonly __typename?: 'ComponentImageBlocksOneImage', readonly idBlock: string, readonly id: string, readonly image: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly mobileImage: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } | { readonly __typename?: 'ComponentImageBlocksTextBlock', readonly id: string, readonly idBlock: string, readonly title: string, readonly description: string } | { readonly __typename?: 'ComponentImageBlocksVideo', readonly id: string, readonly idBlock: string, readonly video: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } | { readonly __typename?: 'Error' }> } } } };
...
export type GetPartnersQuery = { readonly __typename?: 'Query', readonly ourPartners: { readonly __typename?: 'OurPartnerEntityResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'OurPartnerEntity', readonly attributes: { readonly __typename?: 'OurPartner', readonly title: string, readonly noFillImage: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } }, readonly fillImage: { readonly __typename?: 'UploadFileEntityResponse', readonly data: { readonly __typename?: 'UploadFileEntity', readonly attributes: { readonly __typename?: 'UploadFile', readonly name: string, readonly url: string, readonly width: number, readonly height: number, readonly mime: string } } } } }> } };
...
export type GetSeoCaseIdQuery = { readonly __typename?: 'Query', readonly case: { readonly __typename?: 'CaseEntityResponse', readonly data: { readonly __typename?: 'CaseEntity', readonly attributes: { readonly __typename?: 'Case', readonly mobileName: string } } } };
...
export type GetSeoOfferQuery = { readonly __typename?: 'Query', readonly offer: { readonly __typename?: 'OfferEntityResponse', readonly data: { readonly __typename?: 'OfferEntity', readonly attributes: { readonly __typename?: 'Offer', readonly name: string } } } };

export type GetSeoServiceCollectionPageQueryVariables = Exact<{
  id: InputMaybe<Scalars['ID']['input']>;
}>;


export type GetSeoServiceCollectionPageQuery = { readonly __typename?: 'Query', readonly serviceCollection: { readonly __typename?: 'ServiceCollectionEntityResponse', readonly data: { readonly __typename?: 'ServiceCollectionEntity', readonly attributes: { readonly __typename?: 'ServiceCollection', readonly name: string } } } };

export type GetSeoServicesPageQueryVariables = Exact<{
  id: InputMaybe<Scalars['ID']['input']>;
}>;


export type GetSeoServicesPageQuery = { readonly __typename?: 'Query', readonly service: { readonly __typename?: 'ServiceEntityResponse', readonly data: { readonly __typename?: 'ServiceEntity', readonly attributes: { readonly __typename?: 'Service', readonly seo: { readonly __typename?: 'ComponentSharedSeo', readonly metaTitle: string, readonly metaDescription: string, readonly keywords: string, readonly metaRobots: string, readonly structuredData: any, readonly metaViewport: string, readonly canonicalURL: string } } } } };
...
export const BannerFragmentFragmentDoc = gql`
  ...
  bgColorServiceBanner
  colorImageEffectServiceBanner
  imgServiceBanner {
    data {
      attributes {
        ...MediaFragment
  ...
  services(filters: {serviceName: {id: {eq: $id}}}) {
    data {
      attributes {
        ...
        title
        content {
          ... on ComponentServicesContentTextVariant {
            idBlock
            id
            title
            description
          }
          ... on ComponentServicesContentSingleImageBlock {
            idBlock
            id
            title
            description
  ...
  case(id: $id) {
    data {
      attributes {
        ...
        content {
          ... on ComponentImageBlocksAboutProject {
            id
            idBlock
            client
            industry
...
export const GetPartnersDocument = gql`
    query GetPartners {
  ourPartners(sort: "id:asc", pagination: {limit: 150}) {
    data {
      attributes {
        noFillImage {
          data {
...
export const GetSeoServiceCollectionPageDocument = gql`
    query GetSeoServiceCollectionPage($id: ID) {
  serviceCollection(id: $id) {
    data {
      attributes {
        name
...
export const GetSeoServicesPageDocument = gql`
    query GetSeoServicesPage($id: ID) {
  service(id: $id) {
    data {
      attributes {
        seo {

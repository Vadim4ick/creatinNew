...
import { GetComplexByIdQuery } from "@/graphql/__generated__";
...
const PageComplex = ({
  ...
  complex: GetComplexByIdQuery["complex"]["data"]["attributes"];
}) => {
  return (
    <main className="page">
      <div className="page__container page__container--sidebar">
        <div>Sidebar </div>
        ...
        <div className="page__base">
          ...
          >
            <div className="hero__left">
              <h1 className="hero__title">Пакет “{complex.title}”</h1>
